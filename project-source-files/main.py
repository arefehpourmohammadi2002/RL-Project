...
GNN_NODE_DIM = config["transformer"]["GNN_input_embedding"]["node_dim"]
GNN_HiDDEN_DIM = config["transformer"]["GNN_input_embedding"]["hidden_dim"]
GNN_OUTPUT_DIM = config["transformer"]["GNN_input_embedding"]["output_dime"]
GNN_EDGE_DIM = config["transformer"]["GNN_input_embedding"]["edge_dim"]
